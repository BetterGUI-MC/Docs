...
* It consists of:
  ...
  * `success-action` (`success-command`): the [Action](/action) when the player passes all requirements.
  * `fail-action` (`fail-command`): the [Action](/action) when the player doesn't pass any of the requirements.
