...
This addon adds an [Item Modifier](modifier/overview.md) similar to [Enchantment](modifier/enchantment.md) but it uses Minecraft's keys instead of Bukkit's ones. It is useful for those who use custom enchantment plugins and want to add these enchantments to the menu.
