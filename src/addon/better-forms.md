...
::: details For Standalone Server
You can install just Geyser or both Geyser and Floodgate into your server
:::

::: details For Proxied Server (BungeeCord, Velocity, etc.)
...
After downloading the addon and the required plugins, follow [this guide](/basic/addon) to install the addon.