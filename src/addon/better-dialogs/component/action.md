...
Check [Action](/action) for more information about the available actions in `command`.

Check [Requirement](/requirement) for more information about the available requirements in `click-requirement`.
