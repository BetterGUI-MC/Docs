...
This is the same as the [Button Paginated Mask](../button-paginated.md). The only difference is that this mask assumes each button as a page, so it will "shift" the buttons to the left or right depending on the page.
