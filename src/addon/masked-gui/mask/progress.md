...
* `current-button`: The [Button](/button/overview) that represents the filled part of the progress.
* `max-button`: The [Button](/button/overview) that represents the empty part of the progress.
...
![Progress 1](progress/progress-1.gif)None
