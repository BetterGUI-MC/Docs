...
This mask is similar to [Button Paginated Mask](../button-paginated.md), but you can specify a list of values and display each of them as a [Button](button/overview.md).
