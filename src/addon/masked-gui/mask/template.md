...
* `variable`: The variable is a way to pass values to the template mask. Check out [Use `variable` option]((button/template.md)#use-variable-option) for more information.
