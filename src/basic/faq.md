...
Before requesting, you should check if your request already exists on the [Addon](addon.md). If it does not exist, you can either join [my Discord server](https://discord.gg/5vpVM6g4SV) or create [an issue](https://github.com/BetterGUI-MC/Issue-Tracker/issues).