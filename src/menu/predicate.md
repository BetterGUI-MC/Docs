...
This is an arbitrary menu that serves as a switch that you can add some [Menus](menu/overview.md) and some [Requirements](requirement/overview.md) for each [Menu](menu/overview.md) to check before opening one of them.
...
* `menu-name1`, `menu-name2`, etc.
  ...
  * `requirement`: the [Requirement](requirement/overview.md) to check before opening the menu. If it's not set, the plugin will assume that the menu can always be opened.
